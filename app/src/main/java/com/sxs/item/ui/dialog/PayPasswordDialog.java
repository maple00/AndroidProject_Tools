...
import com.sxs.tools.widget.PasswordView;
...
public final class PayPasswordDialog {
    ...
    private static final class KeyboardAdapter extends BaseRecyclerViewAdapters<String> {
        ...
        @NonNull
        @Override
        public BaseRecyclerViewAdapters.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            switch (viewType) {
                case TYPE_DELETE:
                    return new BaseRecyclerViewAdapters.SimpleHolder(R.layout.item_pay_password_delete);
                case TYPE_EMPTY:
                    return new BaseRecyclerViewAdapters.SimpleHolder(R.layout.item_pay_password_empty);
                default:
