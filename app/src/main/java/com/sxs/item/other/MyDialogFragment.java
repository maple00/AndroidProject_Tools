...
public class MyDialogFragment extends DialogFragment {
    ...
    public MyDialogFragment() {
         ...
         * 如果没有预留的话就会抛出：Unable to instantiate fragment com.hjq.base.MyDialogFragment: could not find Fragment constructor
         */
    }

    @SuppressLint("ValidFragment")
    public MyDialogFragment(BaseDialog dialog) {
        mDialog = dialog;
        if (mDialog == null) {
    ...
    public static class Builder<B extends MyDialogFragment.Builder> extends BaseDialog.Builder<B> {
         ...
         */
        protected MyDialogFragment getDialogFragment() {
         ...
         */
        protected MyDialogFragment createDialogFragment(BaseDialog dialog) {
            return new MyDialogFragment(dialog);
        }
